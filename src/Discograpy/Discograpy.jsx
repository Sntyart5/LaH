    ...
    return(
        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-12 col-md-4 divmnc">
            ...
            <div className="row">
                ...
                <div className="col-12 col-md-4 divsb"> 
                    ...
                    <img src="https://firebasestorage.googleapis.com/v0/b/men2kbron.appspot.com/o/3men2-removebg-preview.png?alt=media&token=8e4f2008-80cc-4af3-9c2a-a5785ba094d7" alt="" />
                </div>
