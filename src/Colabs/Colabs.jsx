            ...
            <div className="container disco">
                 <div className="row">
                    ...
                    <div className="col-12 col-md-4"> 
                        ...
                        <h3 className="text-center m-5">{colabracion.descripcion}</h3>
                    </div>
                    <div className="col-12 col-md-4">
